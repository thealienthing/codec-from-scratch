...
TEST_CASE("Frames") {
  Frame f(PixelFormat::RGB24, 1920, 1080);
  CHECK(true);
}

// TEST_CASE("Testing huffman encoding") {
//   const std::string hufftest = "AAAAAABBDSF:"
//                                "LKAJLKSDJFLKJSDLFKJAOAJOAAAAAOFIJAOFJFJAJAOFJAF"
//                                "OAOJFFFBBBCzzzzzzzzzzzzzzzzzzzzzzzzzzCCCDDDEEF";
...
//   Buffer COMPRESSES_TO_HALF =
//   Buffer(std::string("AAAABBBBCCCCDDDDEEEEFFFF")); int size =
//   COMPRESSES_TO_HALF.size(); Buffer compressed = rle(COMPRESSES_TO_HALF);
